...
Once you fill in these values, run `node deploy-commands.js` in your project directory to register your commands to a single guild. If you want to revise the above code to be compatible with multiple guilds, consider [registering commands globally.](/interactions/slash-commands.md#global-commands).
